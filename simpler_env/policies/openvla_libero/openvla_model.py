...
class OpenVLAInference:
    def __init__(
        self,
        saved_model_path: str = "openvla/openvla-7b-finetuned-libero-spatial",
    ...
    def step(
        ...
        print("openvla-liberoooooooooooooooooooooooooooooooooooooooooooo")
        ...
        print("test: ", raw_action["rotation_delta"])
        print("test: ", np.asarray(raw_action["rotation_delta"], dtype=np.float64))
