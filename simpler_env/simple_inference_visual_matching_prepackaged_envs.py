...
parser.add_argument("--policy", default="rt1", choices=["rt1", "octo-base", "octo-small", "openvla/openvla-7b", "openvla/openvla-7b-finetuned-libero-spatial"])
parser.add_argument(
    "--ckpt-path",
    type=str,
    default="None",
...
if args.policy in ["octo-base", "octo-small", "openvla/openvla-7b","openvla/openvla-7b-finetuned-libero-spatial"]:
...
# # new
# elif "openvla-7b-finetuned-libero-spatial" in args.policy:
#     from simpler_env.policies.openvla_libero.openvla_model import OpenVLAInference
